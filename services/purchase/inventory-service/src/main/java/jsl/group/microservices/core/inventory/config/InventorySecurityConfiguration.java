package jsl.group.microservices.core.inventory.config;
...
//                    requests.methods("InventoryService/addProductCount").authenticated()
//                            .methods("InventoryService/subtractProductCount").authenticated()
//                            .methods("InventoryService/isAvailable").authenticated()
